...
class DeepFM(object):
    ...
    def __init__(self, config):
        """
        :param config: 超参数配置 configuration of hyper parameters
        type of dict
        """
        # 潜在因素数 number of latent factors
    ...
    def train(self):
        # 将指数衰减应用于学习速率 Applies exponential decay to learning rate
        # define optimizer
